...
```bash
npm install @longhun/wuwu-renderer
```

## 浏览器用法

```html
<link rel="stylesheet" href="node_modules/@longhun/wuwu-renderer/src/wuwu.css">
<script src="node_modules/@longhun/wuwu-renderer/src/wuwu.js"></script>
<script>
...
{
  "usingComponents": {
    "wuwu-renderer": "@longhun/wuwu-renderer/miniprogram/index"
  }
}
```
