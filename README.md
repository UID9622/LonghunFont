...
**DNA追溯码**: `#龍芯⚡️2026-06-22-LONGHUN-FONT-v0011`  
**归属**: 龍魂系统 × UID9622 原创  
**定位**: CNSH 中文原生字体 · 文化主权 · 办公/终端/全场景  
...
| 传统纹样 | **15** 个 PUA |
| 文化主权图标 | **20** 个 PUA |
| 实用符号（标点/数学/箭头/制表符/货币等） | **151** 个 |
| 字体文件 | `output/LonghunFont-Regular.otf`（OpenType/CFF，255 KB） |
| 字元库文件 | `glyphs/龍魂字元库_v0011_实用符号版.json` |
| SVG 样张 | `output/sample_v0011.html` |
...
│   ├── sample_v0011.html             # 在线样张
│   └── all_glyphs_v0011/             # 2808 个 SVG
├── scripts/              # 构建脚本
...
python3 scripts/build_font.py \
    glyphs/龍魂字元库_v0011_实用符号版.json \
    output/LonghunFont-Regular.otf
```

### 2. 批量渲染 SVG 样张
```bash
python3 scripts/batch_render.py glyphs/龍魂字元库_v0011_实用符号版.json output/all_glyphs_v0011
# 输出：output/all_glyphs_v0011/ 与 output/sample_v0011.html
```
...
**DNA追溯**: `#龍芯⚡️2026-06-22-LONGHUN-FONT-v0011`
